...
public class Book_Package extends JFrame implements ActionListener
{
	 ...
	 Book_Package ()
	{
		 ...
		 ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("truck2.png"));
			 ...
			 public void mouseCliked(MouseEvent arg0)
			 {
				ch2.removeAll();
				 try
				 {
					 ...
					 String q1="select DISTINCT destination transport_driver where source='"+source+"'";
					 ResultSet rest1=obj.stm.executeQuery(q1);
					 while(rest1.next())
					 {
		 ...
		 ch2.addMouseListener(new MouseAdapter()
		 {
			 public void mouseCliked(MouseEvent arg0)
			 {
				 ...
				 try
				 {
					 ConnectionClass obj=new ConnectionClass();
					 String source=ch1.getSelectedItem();
					 String q1="select * from transport_driver1 where source='"+source+"' and destination";
					 ResultSet rest1=obj.stm.executeQuery(q1);
					 while(rest1.next())
					 {
	 ...
	 public void actionPerformed(ActionEvent e)
		{
			 if(e.getSource()==bt1)
			 {
				 ...
				 String drivername=tf5.getText();
				 String source=tf6.getText();
				 String destination=tf7.getText();
				 String weight=tf8.getText();
				 String truck=tf3.getText();
			 ...
			 try
			 {
				 ...
				 String q1="insert into transport_driver1 values('"+bookid+"','"+username+"','"+name+"','"+drivername+"','"+source+"','"+destination+"','"+weight+"','"+truck+"','"+distance+"','"+price+"')";
				 int aa=obj3.stm.executeUpdate(q1);
				 if(aa==1)
				 {

					 JOptionPane.showMessageDialog(null,"Truck successfully Booked  ");
