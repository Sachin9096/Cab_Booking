...
public class Delete_Customer extends JFrame implements ActionListener
{
	...
	Delete_Customer()
	{
		...
		ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("delete.png"));
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==bt1)
		{
			...
			try
			{
				...
				String q1="delete from intecity_car where username='"+username+"'";
				String q2="delete from intracity_cab where username='"+username+"'";
				String q3="delete from transport_driver where username='"+username+"'";
