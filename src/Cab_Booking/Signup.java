...
public class Signup extends JFrame implements ActionListener
{
	...
	Signup()
	{
		...
		ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("man.png"));
	...
	public void actionPerformed(ActionEvent ee)
	{
		if(ee.getSource()==b1);
		{
			...
			try
			{
				...
				if(aa==1)
				{
					JOptionPane.showMessageDialog(null, "Account Created Successfully","Show",JOptionPane.DEFAULT_OPTION);
